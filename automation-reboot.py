...
Click = web.find_element_by_xpath('//*[@id="menu-basic-system-tools-li"]/a/span[2]')
Click.click()

time.sleep(1)

Click = web.find_element_by_xpath('//*[@id="menu-basic-system-tools-li"]/div/ul/li[1]/a/span[2]')
Click.click()
